...
export const GlobalIssueReminder: React.FC<GlobalIssueReminderProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      {isCheckinAlertActive && (
        <div className="mb-4 rounded-xl border border-amber-500/50 bg-gradient-to-r from-amber-500/20 via-orange-500/15 to-amber-500/20 p-4 shadow-lg backdrop-blur-md animate-pulse-glow">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-start sm:items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="font-display font-bold text-amber-200 text-sm tracking-wide">
                    GLOBAL ISSUE CHECK-IN!
                  </span>
                  <span className="text-[11px] text-amber-300/80">· Current: {currentSegmentTitle}</span>
                </div>
                <p className="text-xs text-slate-200 mt-0.5">
                  Are you connecting your current point directly to your Global Issue: <strong className="text-amber-300">"{globalIssue}"</strong>?
                </p>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold text-slate-950 bg-amber-400 hover:bg-amber-300 rounded-lg shadow transition-all whitespace-nowrap"
            >
