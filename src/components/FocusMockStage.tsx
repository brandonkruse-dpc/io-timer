    ...
    <div className="relative min-h-[580px] w-full flex flex-col justify-between rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 sm:p-10 shadow-xl dark:shadow-2xl overflow-hidden transition-colors">
      ...
      <div className="relative z-10 w-full flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-6 border-b border-slate-200 dark:border-slate-800/80">
        <div className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 border border-indigo-500/20">
      ...
      {isCheckinAlertActive && (
        <div className="relative z-20 my-4 rounded-2xl border-2 border-amber-400 bg-amber-50 dark:bg-amber-500/20 p-4 shadow-xl backdrop-blur-md animate-bounce">
      ...
      <div className="relative z-10 my-auto py-8 text-center flex flex-col items-center">
        ...
        {/* Segment pill */}
        <div className="inline-flex items-center gap-2 rounded-full border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-900/90 px-4 py-1.5 text-xs text-slate-800 dark:text-slate-300 shadow-sm">
        ...
        <p className="mt-3 text-sm text-amber-900 dark:text-amber-300/90 max-w-lg font-medium italic">
        ...
        <div className="mt-6 flex flex-col items-center">
          <span
            className={`font-mono-nums text-7xl sm:text-9xl font-black tracking-tight select-none transition-colors duration-300 ${
              isSegmentWarning
                ? 'text-rose-600 dark:text-rose-500 drop-shadow-[0_0_40px_rgba(244,63,94,0.4)] animate-pulse'
                : isRunning
          ...
          <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400 mt-2">
        ...
        {studentData.bullets && studentData.bullets.length > 0 && (
          <div className="mt-6 w-full max-w-2xl rounded-2xl border border-amber-300 dark:border-amber-500/30 bg-amber-50/80 dark:bg-amber-500/10 p-3.5 text-left shadow-sm">
            <span className="text-[10px] font-bold uppercase tracking-wider text-amber-900 dark:text-amber-400 block mb-1">
            ...
            <div className="space-y-1">
              {(segmentIndex === 0
                ...
                <div key={bIdx} className="flex items-start gap-2 text-xs sm:text-sm text-slate-900 dark:text-slate-100 font-medium">
