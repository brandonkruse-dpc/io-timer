...
import { Award, Clock, ShieldCheck, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-900/80 p-6 backdrop-blur-sm shadow-sm dark:shadow-xl transition-colors">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 max-w-2xl font-medium">
              The Individual Oral is assessed out of <strong className="text-slate-900 dark:text-slate-200">40 marks</strong> across 4 criteria. Total weight: <strong className="text-slate-900 dark:text-slate-200">30% for SL</strong> and <strong className="text-slate-900 dark:text-slate-200">20% for HL</strong>.
            </p>
          </div>
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs border-t border-slate-200 dark:border-slate-800/80 pt-4">
          <div className="flex items-start gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800">
            ...
            <div>
              ...
              <span className="text-slate-600 dark:text-slate-400">Examiners must stop timing at 10:00. Anything said past 10:00 is ignored.</span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800">
            ...
            <div>
              ...
              <span className="text-slate-600 dark:text-slate-400">Equal balance between extract & whole work, and between Lit & Non-Lit texts.</span>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5 p-3 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800">
            ...
            <div>
              <strong className="text-slate-900 dark:text-slate-200 block font-semibold">No Text Comparison</strong>
              <span className="text-slate-600 dark:text-slate-400">Never compare the two extracts. Anchor each text independently to the GI!</span>
            </div>
          </div>
        </div>
      </div>
        ...
        {criteria.map((c) => (
          ...
          >
            ...
            <div className="mt-5 pt-3 border-t border-slate-200 dark:border-slate-800/80 text-[11px] rounded-xl bg-white/80 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/60 p-3 shadow-xs">
              <strong className="text-amber-800 dark:text-amber-300 block mb-0.5 font-bold">Top Markband Advice:</strong>
